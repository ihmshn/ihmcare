@extends('layouts.occupational_health')
@section('content')
                    ...
                    <div class="col-xl-12 col-md-12">
                                    <div class="ms-panel">
                                        <div class="ms-panel-header bg-success">
                                            <h6 class="text-white">My Department Partial Consultation List <span class="float-right" style="margin-top: -10px !important;"><div class="input-group">
