...
<!-- <body class="ms-body ms-primary-theme"> -->
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        <a href="dashboard" style="background-color: #033DBB !important;">
          ...
          <span><i class="fas  fa-heart"></i>Main Menu</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="our_patient_list">
          <span><i class="fas fa-arrow-circle-right"></i>OUR Patient List <span class="badge badge-success p-1">0</span></span>
        </a>
      </li>


      <li class="menu-item">
        <a href="out_patient_drug_list">
          <span><i class="fas fa-arrow-circle-right"></i>Out-Patient Drug List <span class="badge badge-success p-1">0</span></span>
        </a>
      </li>


      <li class="menu-item">
        <a href="in_patient_drug_list">
          <span><i class="fas fa-arrow-circle-right"></i>In-Patient Drug List</span>
        </a>
      </li>

       <li class="menu-item">
        <a href="consultation_pa_code" style="background-color: #1877F2 !important;">
          <!-- <span><i class="material-icons fs-16">widgets</i>Widgets</span> -->
          <span><i class="fas  fa-gift"></i>Consultation PA Code</span>
        </a>
      </li>


      <li class="menu-item">
        <a href="daily_patient_visit">
          <span><i class="fas  fa-arrow-circle-right"></i>Daily Patient Visit</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="pacode_note_report">
          <span><i class="fas  fa-arrow-circle-right"></i>Pacode Note Report</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="dashboard" style="background-color: #033DBB !important;">
          <span><i class="fas fa-file"></i>Others </span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="manpower_request">
          <span><i class="fas  fa-arrow-circle-right"></i>Manpower Request</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="clinic_request">
          <span><i class="fas  fa-arrow-circle-right"></i>Clinic Request</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="view_payslip">
          <span><i class="fas  fa-arrow-circle-right"></i>View Payslip</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="asset_management">
          <span><i class="fas  fa-arrow-circle-right"></i>Asset Movement</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="approve_asset_management">
          <span><i class="fas  fa-arrow-circle-right"></i>Approve Asset Movement</span>
        </a>
      </li>
  ...
  <main class="body-content">
    ...
    <!--   <div class=" ms-d-block-sm">
      ...
      <ul class="mt-4 text-white" style="margin-left:-100px !important;"><li class="font-weight-bold"><h5 class=" text-white"> HMO OFFICER (IHM SPECIALIST HOSPITAL)</h5></li></ul>
