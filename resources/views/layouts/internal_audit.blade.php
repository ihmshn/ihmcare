...
<!-- <body class="ms-body ms-primary-theme"> -->
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        <a href="internal_audit">
          <span><i class="fas fa-arrow-circle-right"></i>Internal Audit</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="audit_trail">
          <span><i class="fas fa-arrow-circle-right"></i>Audit Trail</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="dashboard" style="background-color: #033DBB !important;">
          ...
          <span><i class="fas  fa-heart"></i>Pay Point Activities</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="dashboard">
          <span><i class="fas fa-arrow-circle-right"></i>Dashboard</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="pay_point_officer">
          <span><i class="fas fa-arrow-circle-right"></i>Pay point Officer</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="all_transaction_for_op">
          <span><i class="fas fa-arrow-circle-right"></i>All Transaction For OP</span>
        </a>
      </li>
       ...
       <li class="menu-item">
        <a href="dashboard" style="background-color: #033DBB !important;">
          <!-- <span><i class="material-icons fs-16">widgets</i>Widgets</span> -->
          <span><i class="fas  fa-gift"></i>Front Office Activities</span>
        </a>
      </li>


      <li class="menu-item">
        <a href="new_registration">
          <span><i class="fas  fa-arrow-circle-right"></i>New Registration</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="dashboard" style="background-color: #033DBB !important;">
          <!-- <span><i class="material-icons fs-16">widgets</i>Widgets</span> -->
          <span><i class="fas fa-file"></i>Administration </span>
        </a>
      </li>
  ...
  <main class="body-content">
    ...
    <!--   <div class=" ms-d-block-sm">
      ...
      <ul class="mt-4 text-white" style="margin-left:-100px !important;"><li class="font-weight-bold"><h5 class=" text-white"> Internal Audit (IHM SPECIALIST HOSPITAL)</h5></li></ul>
