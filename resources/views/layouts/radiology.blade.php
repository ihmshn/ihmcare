...
<!-- <body class="ms-body ms-primary-theme"> -->
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        <a href="dashboard" style="background-color: #033DBB !important;">
          <span><i class="fas  fa-heart"></i>Radiology Unit</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="reverse_investigations">
          <span><i class="fas fa-arrow-circle-right"></i>Reverse Investigations</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="rdi_result_posting">
          <span><i class="fas fa-arrow-circle-right"></i>RDI Result Posting</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="rdi_posted_result">
          <span><i class="fas fa-arrow-circle-right"></i>RDI Posted Result </span>
        </a>
      </li>
      ...
      <li class="menu-item">
       ...
       <li class="menu-item">
        <a href="dashboard" style="background-color: #033DBB !important;">
          <span><i class="fas  fa-gift"></i>Imaging Report </span>
        </a>
      </li>


      <li class="menu-item">
        <a href="imaging_list_report">
          <span><i class="fas  fa-arrow-circle-right"></i>Imaging List Report</span>
        </a>
      </li>


      <li class="menu-item">
        <a href="imaging_by_category">
          <span><i class="fas  fa-arrow-circle-right"></i>Imaging By Category</span>
        </a>
      </li>


      <li class="menu-item">
        <a href="imaging_by_type">
          <span><i class="fas  fa-arrow-circle-right"></i>Imaging By Type</span>
        </a>
      </li>
  ...
  <main class="body-content">
    ...
    <!--   <div class=" ms-d-block-sm">
      ...
      <ul class="mt-4 text-white" style="margin-left:-100px !important;"><li class="font-weight-bold"><h5 class=" text-white"> Radiology (IHM SPECIALIST HOSPITAL)</h5></li></ul>
