...
<!-- <body class="ms-body ms-primary-theme"> -->
    ...
    <li class="menu-item">
      ...
      <li class="menu-item">
        <a href="?action=from_department">
          <span><i class="fas fa-arrow-circle-right"></i>No Design<span class="badge badge-warning">90</span></span>
        </a>
      </li>

      <li class="menu-item">
        <a href="?action=from_pharmacy">
          <span><i class="fas fa-arrow-circle-right"></i>No Design <span class="badge badge-warning">0</span></span>
        </a>
      </li>

      <li class="menu-item">
        <a href="?action=request_other_branches">
          <span><i class="fas fa-arrow-circle-right"></i>No Design</span>
        </a>
      </li>
  ...
  <main class="body-content">
    ...
    <!--   <div class=" ms-d-block-sm">
      ...
      <ul class="mt-4 text-white" style="margin-left:-100px !important;"><li class="font-weight-bold"><h5 class=" text-white"> Chronic Disease (IHM SPECIALIST HOSPITAL)</h5></li></ul>
