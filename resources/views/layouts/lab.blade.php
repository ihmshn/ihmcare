...
<!-- <body class="ms-body ms-primary-theme"> -->
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        <a href="dashboard" style="background-color: #033DBB !important;">
          <span><i class="fas  fa-heart"></i>Laboratory Unit</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="view_op_bill">
          <span><i class="fas fa-arrow-circle-right"></i>View OP Bill</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="reverse_refund_for_investigations">
          <span><i class="fas fa-arrow-circle-right"></i>Reverse / Refund for Investigations</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="sample_collection">
          <span><i class="fas fa-arrow-circle-right"></i>Sample Collection</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="result_posting">
          <span><i class="fas fa-arrow-circle-right"></i>Result Posting</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="view_result">
          <span><i class="fas fa-arrow-circle-right"></i>View Result </span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="edit_result">
          <span><i class="fas fa-arrow-circle-right"></i>Edit Result</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="validate_result">
          <span><i class="fas fa-arrow-circle-right"></i>Validate Result</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="lab_investigation">
          <span><i class="fas fa-arrow-circle-right"></i>Lab Investigation</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="blood_dispense">
          <span><i class="fas fa-arrow-circle-right"></i>Blood Dispense</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="blood_bank">
          <span><i class="fas fa-arrow-circle-right"></i>Blood Bank</span>
        </a>
      </li>

       <li class="menu-item">
        <a href="dashboard" style="background-color: #033DBB !important;">
          <span><i class="fas  fa-gift"></i>Investigation Report </span>
        </a>
      </li>


      <li class="menu-item">
        <a href="investigation_list_report">
          <span><i class="fas  fa-arrow-circle-right"></i>Investigation List Report</span>
        </a>
      </li>


      <li class="menu-item">
        <a href="investigation_by_category">
          <span><i class="fas  fa-arrow-circle-right"></i>Investigations By Category</span>
        </a>
      </li>


      <li class="menu-item">
        <a href="investigation_by_type">
          <span><i class="fas  fa-arrow-circle-right"></i>Investigations By Type</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="lab_investigation_report">
          <span><i class="fas  fa-arrow-circle-right"></i>Lab Investigations Report</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="dashboard" style="background-color: #033DBB !important;">
          <span><i class="fas fa-gift"></i>Manage Menu </span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="add_new_service">
          <span><i class="fas fa-arrow-circle-right"></i>Add New Service</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="add_service_tariff">
          <span><i class="fas fa-arrow-circle-right"></i>Add Service Tariff</span>
        </a>
      </li>
  ...
  <main class="body-content">
    ...
    <!--   <div class=" ms-d-block-sm">
      ...
      <ul class="mt-4 text-white" style="margin-left:-100px !important;"><li class="font-weight-bold"><h5 class=" text-white"> Lab's Platform (IHM SPECIALIST HOSPITAL)</h5></li></ul>
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
            <li class="dropdown-menu-header">
              <h6 class="dropdown-header ms-inline m-0"><span class="text-disabled">Welcome, <?php //cho $_SESSION['username']; ?></span></h6>
            </li>
