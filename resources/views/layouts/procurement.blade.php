...
<!-- <body class="ms-body ms-primary-theme"> -->
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        <a href="?action=dashboard" style="background-color: #033DBB !important;">
          <!-- <span><i class="material-icons fs-16">widgets</i>Widgets</span> -->
          <span><i class="fas  fa-heart"></i>P O and Quotation Menu</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="?action=raise_po_normal">
          <span><i class="fas fa-arrow-circle-right"></i>Raise P O (Normal)</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="?action=raise_po_direct">
          <span><i class="fas fa-arrow-circle-right"></i>Raise P O (Direct)</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="?action=print_po">
          <span><i class="fas fa-arrow-circle-right"></i>Print P O</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="?action=manage_po">
          <span><i class="fas fa-arrow-circle-right"></i>Manage P O </span>
        </a>
      </li>

      <li class="menu-item">
        <a href="?action=manage_po">
          <span><i class="fas fa-arrow-circle-right"></i>Print Quotation</span>
        </a>
      </li>
       ...
       <li class="menu-item">
        <a href="?action=dashboard" style="background-color: #033DBB !important;">
          <!-- <span><i class="material-icons fs-16">widgets</i>Widgets</span> -->
          <span><i class="fas  fa-gift"></i>Administrative Menu</span>
        </a>
      </li>


      <li class="menu-item">
        <a href="?action=add_new_vendor">
          <span><i class="fas  fa-arrow-circle-right"></i>Add New Vendor</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="?action=check_reorder_level">
          <span><i class="fas  fa-arrow-circle-right"></i>Check Reorder Level</span>
        </a>
      </li>


      <li class="menu-item">
        <a href="?action=stock_balance">
          <span><i class="fas  fa-arrow-circle-right"></i>Stock Balance</span>
        </a>
      </li>


      <li class="menu-item">
        <a href="?action=stockedin_item">
          <span><i class="fas  fa-arrow-circle-right"></i>Stocked-in Item</span>
        </a>
      </li>


      <li class="menu-item">
        <a href="?action=stock_aging_analysis">
          <span><i class="fas  fa-arrow-circle-right"></i>Stock Aging Analysis</span>
        </a>
      </li>
  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        ...
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="index-2.html"><img src="../ihmcareicon.png" alt="logo"> </a>
      </div>
    ...
    <!--   <div class=" ms-d-block-sm">
      ...
      <ul class="mt-4 text-white" style="margin-left:-100px !important;"><li class="font-weight-bold"><h5 class=" text-white"> Procurement  (IHM SPECIALIST HOSPITAL)</h5></li></ul>
