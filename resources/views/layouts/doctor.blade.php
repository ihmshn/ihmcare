...
<!-- <body class="ms-body ms-primary-theme"> -->
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        <a href="op_list">
          <span><i class="fas fa-arrow-circle-right"></i>OP List </span>
        </a>
      </li>

      <li class="menu-item">
        <a href="vip_list">
          <span><i class="fas fa-arrow-circle-right"></i>VIP List</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="ip_list">
          <span><i class="fas fa-arrow-circle-right"></i>IP List</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="medical_fittness">
          <span><i class="fas fa-arrow-circle-right"></i>Medical Fitness Patient</span>
        </a>
      </li>
       ...
       <li class="menu-item">
        <a href="" style="background-color: #033DBB !important;">
          ...
          <span><i class="fas  fa-gift"></i>Partial Consultation </span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="op_consult">
          <span><i class="fas  fa-arrow-circle-right"></i>OP Consult</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="" style="background-color: #033DBB !important;">
          <span><i class="fas fa-sitemap"></i>Manage Menu </span>
        </a>
      </li>


      <li class="menu-item">
        <a href="check_patient_bill">
      ...
      <li class="menu-item">
        <a href="book_operation">
          <span><i class="fas  fa-arrow-circle-right"></i>Book Operation</span>
        </a>
      </li>


      <li class="menu-item">
        <a href="bundle_package_creation">
          <span><i class="fas  fa-arrow-circle-right"></i>Bundle Package Creation</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="add_diagnosis">
          <span><i class="fas  fa-arrow-circle-right"></i>Add Diagnosis</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="update_diagnosis">
          <span><i class="fas  fa-arrow-circle-right"></i>Update Diagnosis</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="mysignature">
          <span><i class="fas  fa-arrow-circle-right"></i>My Signature</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="doctors_report">
          <span><i class="fas  fa-arrow-circle-right"></i>Doctors Report</span>
        </a>
      </li>


      <li class="menu-item">
        <a href="doctors_operation_note">
          <span><i class="fas  fa-arrow-circle-right"></i>Document Operation Note</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="view_operation_note">
          <span><i class="fas  fa-eye"></i>View Operation Note</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="search_consultation_by_diagnosis">
          <span><i class="fas  fa-arrow-circle-right"></i>Search Consultaion By Diagnosis</span>
        </a>
      </li>


      <li class="menu-item">
        <a href="waiting_time_report">
          <span><i class="fas  fa-arrow-circle-right"></i>Waiting Time Report</span>
        </a>
      </li>


      <li class="menu-item">
        <a href="item_requistion">
          <span><i class="fas  fa-arrow-circle-right"></i>Item Requistion</span>
        </a>
      </li>
  ...
  <main class="body-content">
    ...
    <!--   <div class=" ms-d-block-sm">
      ...
      <ul class="mt-4 text-white text-center">
        ...
        <h5 class=" text-white"> Doctor's Platform (IHM SPECIALIST HOSPITAL)</h5>
      </li>
    </ul>
