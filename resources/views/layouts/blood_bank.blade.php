...
<!-- <body class="ms-body ms-primary-theme"> -->
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        <a href="" style="background-color: #033DBB !important;">
          <span><i class="fas  fa-heart text-danger"></i>Donor Management</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="1">
           <span><i class="fas fa-arrow-circle-right"></i>Donor registration</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="2">
          <span><i class="fas fa-arrow-circle-right"></i>Donor screening</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="#">
          <span><i class="fas  fa-arrow-circle-right"></i>Eligible Donors</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="">
          <span><i class="fas fa-arrow-circle-right"></i>Donor tracking</span>
        </a>
      </li>
       ...
       <li class="menu-item">
        <a href="" style="background-color: #033DBB !important;">
          <span><i class="fas  fa-heart text-danger"></i>Collection and Processing</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="">
          <span><i class="fas  fa-arrow-circle-right"></i>Donation Scheduling </span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="">
          <span><i class="fas  fa-arrow-circle-right"></i>Collection and Storage</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="#">
          <span><i class="fas  fa-arrow-circle-right"></i>Testing and Screening</span>
        </a>
      </li>
        ...
        <li class="menu-item">
        <a href="">
          <span><i class="fas  fa-arrow-circle-right"></i>Separation and Preparation</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="" style="background-color: #033DBB !important;">
          <span><i class="fas  fa-heart text-danger"></i>Inventory</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="">
          <span><i class="fas  fa-arrow-circle-right"></i>Inventory Tracking</span>
        </a>
      </li>
       ...
       <li class="menu-item">
        <a href="">
          <span><i class="fas  fa-arrow-circle-right"></i>Type and Matching</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="">
          <span><i class="fas  fa-arrow-circle-right"></i>Expiration and Disposal</span>
        </a>
      </li>
       ...
       <li class="menu-item">
        <a href="">
          <span><i class="fas  fa-arrow-circle-right"></i>Restock and Procurement</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="" style="background-color: #033DBB !important;">
          <span><i class="fas  fa-heart text-danger"></i>Transfusion </span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="">
          <span><i class="fas  fa-arrow-circle-right"></i>Transfusion Request</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="">
          <span><i class="fas  fa-arrow-circle-right"></i>Testing and Cross-matching</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="">
          <span><i class="fas  fa-arrow-circle-right"></i>Transfusion Administration</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="">
          <span><i class="fas  fa-arrow-circle-right"></i>Transfusion Reporting</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="" style="background-color: #033DBB !important;">
          <span><i class="fas  fa-heart text-danger"></i>Quality Control</span>
        </a>
      </li>  
      ...
      <li class="menu-item">
        <a href="">
          <span><i class="fas  fa-arrow-circle-right"></i>Safety / Quality Assurance</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="">
          <span><i class="fas  fa-arrow-circle-right"></i>Incident reporting / investigation</span>
        </a>
      </li>
       ...
       <li class="menu-item">
        <a href="">
          <span><i class="fas  fa-arrow-circle-right"></i>Request</span>
        </a>
      </li>
  ...
  <main class="body-content">
    ...
    <!--   <div class=" ms-d-block-sm">
      ...
      <ul class="mt-4 text-white text-center"><li class="font-weight-bold"><h5 class=" text-white"> Blood Bank Platform (IHM SPECIALIST HOSPITAL)</h5></li></ul>
