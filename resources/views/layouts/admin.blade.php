...
<!-- <body class="ms-body ms-primary-theme"> -->
  ...
  <a href="dashboard" style="background-color: #033DBB !important;">
    ...
    <li class="menu-item">
      <a href="manage_role">
        <span><i class="fas fa-user-tag"></i>Manage Roles</span>
      </a>
    </li>


      <li class="menu-item">
        <a href="manage_branch">
          <span><i class="fas fa-building"></i>Manage Branches</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="manage_departments">
          <span><i class="fas fa-sitemap"></i>Manage Departments</span>
        </a>
      </li>


            <li class="menu-item">
        <a href="manage_theatre">
          <span><i class="fas fa-procedures"></i>Manage Theatres</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="expense_management">
          <span><i class="fas fa-money-check-alt"></i>Expense Management</span>
        </a>
      </li>


    <li class="menu-item">
        <a href="manage_insurance">
          <span><i class="fas fa-file-medical"></i>Manage Insurance</span>
        </a>
      </li> 
    ...
    <li class="menu-item">
      <a href="manage_service">
        <span><i class="fas fa-concierge-bell"></i>Manage Services</span>
      </a>
    </li>


            <li class="menu-item">
      <a href="manage_tariffs">
        <span><i class="fas fa-file-invoice-dollar"></i>Manage Tariffs</span>
      </a>
    </li>
    ...
    <li class="menu-item">
          <a href="manage_doctors">
            <span><i class="fas fa-user-md"></i>Manage Doctors</span>
          </a>
      </li>
    ...
    <a href="store_management">
        <span><i class="fas fa-warehouse"></i>Store Management</span>
    </a>
    </li>

     <li class="menu-item">
        <a href="manage_bed">
          <span><i class="fas fa-bed"></i>Manage Beds</span>
        </a>
      </li>
        ...
        <li class="menu-item">
          <a href="patient_management">
            <span><i class="fas fa-procedures"></i>Patient Management</span>
          </a>
        </li>
          ...
          <li class="menu-item">
      <a href="reporting">
        <span><i class="fas fa-chart-line"></i>Reporting</span>
      </a>
    </li>
  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar"> 
      ...
      <ul class="mt-4 text-white text-center"><li class="font-weight-bold"><h5 class=" text-white"> Admin Panel (IHM SPECIALIST HOSPITAL)</h5></li></ul>
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">

        <li class="ms-nav-item ms-nav-user dropdown">
          <a href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <!-- <img class="ms-user-img ms-img-round float-right" src="assets/img/dashboard/doctor-3.jpg" alt="people">  -->
             <button class="btn btn-success btn-sm" >Logged User - <?php //echo $_SESSION['name']; ?></button> </a>
