...
<!-- <body class="ms-body ms-primary-theme"> -->
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <li class="menu-item">
        <a href="?action=NewSession">
            <span><i class="fas fa-arrow-circle-right"></i> New Session</span>
        </a>
    </li>
    
    <li class="menu-item">
        <a href="?action=ViewSessions">
            <span><i class="fas fa-calendar-check"></i> View Sessions</span>
        </a>
    </li>
    
    <li class="menu-item">
        <a href="?action=AddDrugEntry">
            <span><i class="fas fa-pills"></i> Add Drug Entry</span>
        </a>
    </li>
    
    <li class="menu-item">
        <a href="?action=ViewDrugEntries">
            <span><i class="fas fa-prescription-bottle-alt"></i> View Drug Entries</span>
        </a>
    </li>
    
    <li class="menu-item">
        <a href="?action=NewPaymentPlan">
            <span><i class="fas fa-file-invoice-dollar"></i> New Payment Plan</span>
        </a>
    </li>
    
    <li class="menu-item">
        <a href="?action=ViewBills">
            <span><i class="fas fa-file-invoice"></i> View Bills</span>
        </a>
    </li>
    
    <li class="menu-item">
        <a href="?action=GenerateReports">
            <span><i class="fas fa-chart-line"></i> Generate Reports</span>
        </a>
    </li>
    
    <li class="menu-item">
        <a href="?action=ViewPastReports">
            <span><i class="fas fa-file-alt"></i> View Past Reports</span>
        </a>
    </li>
    
    <li class="menu-item">
        <a href="?action=Requisition">
            <span><i class="fas fa-clipboard-list"></i> Requisition</span>
        </a>
    </li>
  ...
  <main class="body-content">
    ...
    <!--   <div class=" ms-d-block-sm">
      ...
      <ul class="mt-4 text-white" style="margin-left:-100px !important;"><li class="font-weight-bold"><h5 class=" text-white"> Dailysis Unit (IHM SPECIALIST HOSPITAL)</h5></li></ul>
