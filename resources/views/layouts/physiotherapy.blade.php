...
<!-- <body class="ms-body ms-primary-theme"> -->
  ...
  <main class="body-content">
    ...
    <!--   <div class=" ms-d-block-sm">
      ...
      <ul class="mt-4 text-white" style="margin-left:-100px !important;"><li class="font-weight-bold"><h5 class=" text-white"> Physiotherapy (IHM SPECIALIST HOSPITAL)</h5></li></ul>
