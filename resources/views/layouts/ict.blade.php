...
<!-- <body class="ms-body ms-primary-theme"> -->
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        <a href="?action=reset_user">
          <span><i class="fas fa-arrow-circle-right"></i>Reset User</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="?action=edit_private_tariffS">
          <span><i class="fas fa-arrow-circle-right"></i>Edit Private Tariff(Services)</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="?action=all_services">
          <span><i class="fas fa-arrow-circle-right"></i>All Services</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="?action=add_theatre">
          <span><i class="fas fa-arrow-circle-right"></i>Add Theatre</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="?action=setup_corporate_insurance">
          <span><i class="fas fa-arrow-circle-right"></i>Setup Corporate Insurance</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="?action=setup_hmo_plan_type">
      ...
      <li class="menu-item">
        ...
        <li class="menu-item">
        <a href="?action=corporate_insurance">
          <span><i class="fas  fa-arrow-circle-right"></i>Corprate / Insurance</span>
        </a>
      </li>


       <li class="menu-item">
        <a href="?action=private">
          <span><i class="fas  fa-arrow-circle-right"></i>Private</span>
        </a>
      </li>

       <li class="menu-item">
        <a href="?action=registration_tariff">
          <span><i class="fas  fa-arrow-circle-right"></i>Registration Tariff</span>
        </a>
      </li>

      <li class="menu-item">
        <a href="?action=add_new_user">
          <span><i class="fas  fa-arrow-circle-right"></i>Add New User</span>
        </a>
      </li>


      <li class="menu-item">
        <a href="?action=add_new_doctor">
          <span><i class="fas  fa-arrow-circle-right"></i>Add New Doctor</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="?action=item_expense_request">
      ...
      <li class="menu-item">
        <a href="?action=list_specialty">
          <span><i class="fas  fa-arrow-circle-right"></i>List Specialty</span>
        </a>
      </li>
  ...
  <main class="body-content">
    ...
    <!--   <div class=" ms-d-block-sm">
      ...
      <ul class="mt-4 text-white" style="margin-left:-100px !important;"><li class="font-weight-bold"><h5 class=" text-white"> ICT ADMIN (IHM SPECIALIST HOSPITAL)</h5></li></ul>
