...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <!-- Iconic Fonts -->
    ...
    <link href="{{ asset('vendors/iconic-fonts/cryptocoins/cryptocoins.css') }}" rel="stylesheet">
    <link href="{{ asset('vendors/iconic-fonts/cryptocoins/cryptocoins-colors.css') }}" rel="stylesheet">
