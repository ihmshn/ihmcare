                  ...
                  <div class="ms-panel-body">
                   <form method="post">
                      ...
                      <div class="form-group">
                        <label for="categoryName">Branch Name</label>
                     ...
                     <div class="form-group">
                        <label for="categoryName">Branch Prefix</label>
                        <input type="text" class="form-control" name="BranchPrefix" id="BranchPrefix">
                      </div>
                     ...
                     <div class="col-md-6"> 
                      <div class="form-group">
                        <label for="categoryName">Company</label>
                     ...
                     <div class="form-group">
                        <label for="categoryName">ContactPerson</label>
                     ...
                     <div class="form-group">
                      ...
                      <button class="btn btn-primary mt-4 d-inline w-20 float-right mr-3" name="editBtranch" type="submit">Update</button>&nbsp;
...
function mesansgetCate(categoryId) {
        ...
        var tr = categoryId;
        var url = "admin_control/ajaxController.php?getbranchedit=" + tr;
        ...
        // };
         ...
         xmlhttp.onreadystatechange = function () {
             if (this.readyState == 4 && this.status == 200) {
                 var result = this.responseText.split("*");
                 document.getElementById('BranchName').value = result[0];
                 document.getElementById('BranchPrefix').value = result[1];
                 document.getElementById('Company').value = result[2];
                 document.getElementById('Address').value = result[3];
                 document.getElementById('Email').value = result[4];
                 document.getElementById('Phone').value = result[5];
                 document.getElementById('ContactPerson').value = result[6];
