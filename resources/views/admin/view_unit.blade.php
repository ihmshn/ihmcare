...
<div class="col-xl-12 col-md-12">
	...
	<tbody>
        ...
        //  // echo $date_year[1];
        //  $resultset = $Fcall->fetch_table_only('unitname');
        //     if (!empty($resultset)) {
        ...
        <div class="modal-dialog ms-modal-dialog-width">
          <div class="modal-content ms-modal-content-width">
            <div class="modal-header  ms-modal-header-radius-0">
              <h4 class="modal-title text-white">Edit Unit</h4>
                   ...
                   <form method="post">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-md-12 mb-3">
                          ...
                          <button class="btn btn-primary mt-4 d-inline w-20 float-right mr-3" name="editUnit" type="submit">Update</button>&nbsp;
...
function mesansgetCate(categoryId) {
        ...
        var tr = categoryId;
        var url = "admin_control/ajaxController.php?getunitedit=" + tr;
