...
<div class="col-xl-12 col-md-12">
    <div class="ms-panel">
        <div class="ms-panel-header ms-panel-custome">
            <h6 class="">Add Speciality Corporate / Insurance</h6>
        ...
        <div class="ms-panel-body">
            ...
            <div class="form-row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="corporate_insurance" placeholder="Corporate / Insurance Name">
                    </div>
                </div>
                ...
                <label for="validationCustom002">Company Type</label>
