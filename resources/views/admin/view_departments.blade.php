...
<div class="col-xl-12 col-md-12">
	...
	<tbody>
        ...
        //  // echo $date_year[1];
        //  $resultset = $Fcall->fetch_table_only('departmentgrouptype');
        //     if (!empty($resultset)) {
        ...
        <div class="modal-dialog ms-modal-dialog-width">
          <div class="modal-content ms-modal-content-width">
            <div class="modal-header  ms-modal-header-radius-0">
              <h4 class="modal-title text-white">Edit Department Type</h4>
                  ...
                  <div class="ms-panel-body">
                   <form method="post">
                      ...
                      <div class="form-group">
                        <label for="categoryName">Current Type</label>
                        <input type="text" readonly class="form-control" id="old_name" name="old_name">
                      </div>

                     <div class="form-group">
                        <label for="categoryName">Change Type</label>
                      ...
                      <button class="btn btn-primary mt-4 d-inline w-20 float-right mr-3" name="editType" type="submit">Update</button>&nbsp;
...
function mesansgetCate(categoryId) {
        ...
        var tr = categoryId;
        var url = "admin_control/ajaxController.php?getdeptedit=" + tr;
